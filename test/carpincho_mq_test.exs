defmodule CarpinchoMQTest do
  ...
  describe "Push Message" do
    ...
    test "the queue sends the message to all subscribers if it has pub-sub work mode" do
      ...
      assert (logs_captured =~ "The consumer: consumer1 received the message: General Kenobi... - Grievous" and logs_captured =~ "The consumer: consumer2 received the message: General Kenobi... - Grievous")
    end
